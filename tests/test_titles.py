...
def test_recorded_resolver_title_and_authors_are_written_into_the_pdf_and_leave_the_provenance_as_captured(capsys: pytest.CaptureFixture[str], tmp_path: Path) -> None:
    ...
    app(["metadata", str(tmp_path), "notes", "Ten Lectures on Integral Lattices", "resolver", "--author", "Maryna Viazovska", "--author", "Henry Cohn", "--year", "2017", "--abstract", ABSTRACT], result_action="return_value")
