...
The focus request did not move keyboard focus under Hyprland: Tauri's `set_focus` resolves but does nothing on the Wayland backend (tauri-apps/tauri#14913, tracked in #13). The navigation is not affected.
